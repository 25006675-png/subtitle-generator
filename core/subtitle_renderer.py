...
def build_render_params(
    ...
    *,
    ...
    return {
        ...
        "classic_dimmed_opacity": anim_settings.classic_dimmed_opacity,
        "classic_active_marker": anim_settings.classic_active_marker,
        "classic_history_on": anim_settings.classic_history_on,
        "popup_trail_count": anim_settings.popup_trail_count,
        "popup_min_chars": anim_settings.popup_min_chars,
        "wordbyw_entry_style": anim_settings.wordbyw_entry_style,
        "wordbyw_history_dim": anim_settings.wordbyw_history_dim,
...
class SubtitleOverlayRenderer:
    ...
    def render_on_image(self, image: Image.Image, sub, params: dict) -> Image.Image:
        ...
        if karaoke == "classic" and getattr(sub, "words", None):
            return self._draw_karaoke_classic(image, sub, params)
        if karaoke == "popup" and getattr(sub, "words", None):
            return self._draw_karaoke_popup(image, sub, params)
        if karaoke == "word_by_word" and getattr(sub, "words", None):
            return self._draw_karaoke_word_by_word(image, sub, params)
    ...
    def _draw_karaoke_classic(self, img: Image.Image, sub, params: dict) -> Image.Image:
        ...
        active_marker = params["classic_active_marker"]
        history_on = params["classic_history_on"]
        use_color = "color" in active_marker
        use_box = "box" in active_marker
        dimmed_alpha = int(params["classic_dimmed_opacity"] * 255)
    ...
    def _draw_karaoke_popup(self, img: Image.Image, sub, params: dict) -> Image.Image:
        ...
        min_chars = params.get("popup_min_chars", 3)
        merged = []
        index = 0
